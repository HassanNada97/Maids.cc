...
public class BorrowController {
    ...
    public BorrowController(BookingRecordService bookingRecordService, BookService bookService, PatronService patronService) {
    ...
    public void borrowBook(@PathVariable int bookId, @PathVariable int patronId){
        ...
        this.bookingRecordService.borrowBook(book, patron);
